...
def init_environment():
  ...
  setBlConfig("fastDPNode5","titania-cpu005")
  setBlConfig("fastdpComm", "/nsls2/software/mx/nyx/DIALS/dials-current/build/bin/fast_dp -j 12 -k 8 -e 'titania-cpu002 titania-cpu003 titania-cpu004 titania-cpu005'")
